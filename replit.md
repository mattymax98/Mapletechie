...
- Canonical public site: `https://www.mapletechie.com`. Cloudflare owns
  hostname and HTTP-to-HTTPS redirects; the frontend server does not duplicate
  those edge redirects. The app retains only content-specific redirects and
  intentional `410 Gone` responses.
